...
import "./Rating.css";
import AvgRating from "../../images/rating1.png";
import star5 from "../../images/5starRating.png";
import star4 from "../../images/4starRating.png";
import { clientRatings } from "../../Rating";
  ...
  return (
    <div className="rating_wrapper">
      ...
      <div className="client">
        {clientRatings.map((el, index) => {
          return (
            <div className="client_rating">
              <div className="client_rating_details">
                <img src={el.starts === 5 ? star5 : star4} alt="" />
                <p>
                  <b>{el.client}</b>,{el.date}
                </p>
              </div>
              <h6>{el.title}</h6>
              <p>{el.text}</p>
